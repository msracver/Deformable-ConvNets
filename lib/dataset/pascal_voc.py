...
# Modified by Haozhi Qi, Zheng Zhang, from py-faster-rcnn (https://github.com/rbgirshick/py-faster-rcnn)
# --------------------------------------------------------
...
class PascalVOC(IMDB):
    ...
    def evaluate_sds(self, all_boxes, all_masks):
        self._write_voc_sds_results_file(all_boxes, all_masks)
        info = self._py_evaluate_mask()
        return info
    ...
    def _write_voc_sds_results_file(self, all_boxes, all_masks):
        """
