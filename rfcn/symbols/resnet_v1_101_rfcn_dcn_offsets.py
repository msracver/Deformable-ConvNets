...
class resnet_v1_101_rfcn_dcn_offsets(Symbol):
    ...
    def get_symbol(self, cfg, is_train=True):
        ...
        if is_train:
            ...
            group = mx.sym.Group([rois, cls_prob, bbox_pred, res5a_branch2b_offset, res5b_branch2b_offset, res5c_branch2b_offset])
