...
## Demo & Pre-trained Deformable Model

We provide deformable convnet models, including deformable R-FCN & Faster R-CNN pre-trained on COCO trainval, and deformable DeepLab models pre-trained on CityScapes train.
