...
update_config(cur_path + '/../experiments/fpn/cfgs/resnet_v1_101_icdar_17_combined_fpn_dcn_end2end_ohem.yaml')
...
EXPERIMENT_NAME = "3cls-false_examples-" + str(MODEL_EPOCH) + "ep-" + str(CONFIDENCE_THRESHOLD) + "conf"
MODEL_PATH = './output/fpn/ICDAR_17_COMBINED/resnet_v1_101_icdar_17_combined_fpn_dcn_end2end_ohem/train/fpn_icdar_17_combined'
...
def main():
    ...
    outputBaseDir = '/mnt/Imran/StructureResults/ _ICDAR_17_COMBINED_Deformable-fpn-model-' + EXPERIMENT_NAME
