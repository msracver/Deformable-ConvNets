...
update_config(cur_path + '/../experiments/fpn/cfgs/resnet_v1_101_icdar_17_row_fpn_dcn_end2end_ohem.yaml')
...
CLASSES = ['row']
CONCERNED_ERRORS = ['row']
WRITE_DETECTION_RESULTS = True

MODEL_EPOCH = 50
CONFIDENCE_THRESHOLD = 0.5
EXPERIMENT_NAME = "2cls-false_examples-" + str(MODEL_EPOCH) + "ep-" + str(CONFIDENCE_THRESHOLD) + "conf"
MODEL_PATH = './output/fpn/ICDAR_17_ROW/resnet_v1_101_icdar_17_row_fpn_dcn_end2end_ohem/train/fpn_icdar_17_row'
...
def main():
    ...
    outputBaseDir = '/mnt/Imran/StructureResults/ _ICDAR_17_ROW_Deformable-fpn-model-' + EXPERIMENT_NAME
