...
update_config(cur_path + '/../experiments/fpn/cfgs/resnet_v1_101_icdar_str_devkit_row_fpn_dcn_end2end_ohem.yaml')
...
def main():
    ...
    outputBaseDir = '/mnt/Imran/StructureResults/ _ICDAR_13_ROW_Deformable-fpn-model-' + EXPERIMENT_NAME
