...
update_config(cur_path + '/../experiments/fpn/cfgs/resnet_v1_101_icdar_str_devkit_trainval_fpn_dcn_end2end_ohem.yaml')
...
IoU_THRESHOLDS = ['0.5']
TESTING_SCALES = [0.5, 0.75, 1.0, 1.5, 2.0]

# set up class names
CLASSES = ['table']
TOTAL_CLASSES = ['__background__', 'table', 'figure', 'formula']
...
EXPERIMENT_NAME = "icdar17-fpn-4cls-false_examples-" + str(MODEL_EPOCH) + "ep-" + str(CONFIDENCE_THRESHOLD) + "conf-multiscale"
...
def main():
    ...
    # load demo data
    dataBaseDir = '/netscratch/siddiqui/TableDetection/data/'
    outputBaseDir = '/netscratch/siddiqui/TableDetection/DetectionResults/' + EXPERIMENT_NAME
