...
EXPERIMENT_NAME = "icdar13-fpn-4cls-false_examples-" + str(MODEL_EPOCH) + "ep-" + str(CONFIDENCE_THRESHOLD) + "conf-multiscale"
MODEL_PATH = './output/fpn/icdar13_50ep/resnet_v1_101_icdar13_trainval_fpn_dcn_end2end_ohem/train_icdar13/fpn_icdar13_4cls_50ep'
...
def main():
    ...
    # load demo data
    dataBaseDir = '/mnt/TableDetection/data/'
    outputBaseDir = '/mnt/TableDetection/DetectionResults/' + EXPERIMENT_NAME
    ...
    im_names_file = open(os.path.join(dataBaseDir, 'ImageSets/test_icdar13.txt'), 'r')
